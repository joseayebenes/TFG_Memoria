...
\begin{description}
	\item[Aplication:] Este bloque contiene la lógica específica de la aplicación a desarrollar.
...
Para este proyecto se han definido dos tipo de nodos diferentes basados en la web física, uno definido como genérico y otro como nodo parking. Ambos se explicarán con más detalle a continuación.\\
