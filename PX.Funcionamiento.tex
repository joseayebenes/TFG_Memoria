...
Después de iniciar el servidor, es posible acceder a la web de gestión desde la dirección dns de la instancia del servidor en el puerto 5000. Inicialmente el concentrador no está conectado por lo que nos aparece un mensaje indicándolo, figura \ref{fig:screenWebNotConnected}.
...
\sectionx{Administración de los nodos}
