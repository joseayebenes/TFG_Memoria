...
La función \textit{Collector\_process()} del fichero \textit{collector.c} contiene la lógica de esta tarea, que se describe en la figura ??.
...
\lstinputlisting[caption=Archivo appsrv.h,label=lst:protofield,linewidth=\textwidth,breaklines=true,language=C++]{code/Smsgs_msgStatsField.proto}
