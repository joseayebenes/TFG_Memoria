...
\begin{acronym}[DLMS/COSEMM]
	...
	%N
	\acro{NPI}{\textit{Network Processor Interface}}
	\acro{NWK}{\textit{Network}}
	%O
	%P
	\acro{PAN}{red de área personal o \textit{Personal Area Network}}
	...
	\acro{RTOS}{Sistema operativo en tiempo real o \textit{Real-Time Operating System}}
	%S
	%T
	...
	%V
	%W
	\acro{Wavenis-OSA}{\textit{Wavenis Open Standard Alliance}}
